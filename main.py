...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCH):
        ...
        if val_metrics[0] > max_auc and val_metrics[1] > max_aupr:
            ...
            best_model = model
            print('Get a better performance! Max_AUC = ' + str(max_auc) + ' and Max_AUPR = ' + str(val_metrics[1]) + 'ACC SEN SPE = ' + str(max_acc) + str(max_sen) + str(max_spe))
    torch.save(best_model.state_dict(), 'models/Ablation_only_structure_' + task + '.pth')
